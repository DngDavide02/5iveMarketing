        ...
        <div className="footer-grid">
          ...
          <nav className="footer-section nav-links">
            ...
            <ul className="footer-nav-list">
              ...
              <li>
                <button onClick={() => scrollToSection("services")} className="footer-link" aria-label="Scopri i nostri servizi">
                  Servizi
                </button>
              </li>
              <li>
          ...
          <div className="footer-section contact-info">
            ...
            <div className="contact-item">
              ...
              <span className="footer-text">Milano, Italia</span>
            </div>
          </div>
          ...
          <div className="footer-section social-links">
            ...
            <div className="social-icons">
              ...
              <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="Seguici su GitHub">
                <svg viewBox="0 0 24 24" fill="currentColor">
